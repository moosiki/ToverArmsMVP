package com.tover.manage.module_reportform.app;
...
import com.tover.manage.module_reportform.BuildConfig;
 ...
 * CommonSDK 中已有 {@link com.tover.manage.commonsdk.core.GlobalConfiguration 配置有所有组件都可公用的配置信息
 * 这里用来配置一些组件自身私有的配置信息
 *
