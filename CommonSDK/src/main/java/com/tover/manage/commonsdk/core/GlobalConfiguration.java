package com.tover.manage.commonsdk.core;
...
import com.tover.manage.commonsdk.BuildConfig;
import com.tover.manage.commonsdk.http.Api;
import com.tover.manage.commonsdk.http.SSLSocketClient;
import com.tover.manage.commonsdk.imageEngine.Strategy.CommonGlideImageLoaderStrategy;
...
public class GlobalConfiguration implements ConfigModule {
    ...
    public void applyOptions(Context context, GlobalConfigModule.Builder builder) {
        ...
        builder.baseurl(Api.APP_DOMAIN)
                ...
                .globalHttpHandler(new GlobalHttpHanderImpl(context))
